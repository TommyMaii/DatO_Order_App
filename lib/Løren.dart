...
class loren extends StatefulWidget {
  const loren({super.key});

  @override
  State<loren> createState() => _lorenState();
}

class _lorenState extends State<loren> {
  String _dropdownValue = "Løren";
  String Day = '12';
