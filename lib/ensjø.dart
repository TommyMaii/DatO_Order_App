...
class ensjo extends StatefulWidget {
  const ensjo({super.key});

  @override
  State<ensjo> createState() => _ensjoState();
}

class _ensjoState extends State<ensjo> {
  String _dropdownValue = "Ensjø";
  String Day = '12';
