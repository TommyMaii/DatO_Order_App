...
class akerbrygge extends StatefulWidget {
  const akerbrygge({super.key});

  @override
  State<akerbrygge> createState() => _akerbryggeState();
}

class _akerbryggeState extends State<akerbrygge> {
  String _dropdownValue = "AkerBrygge";
  String Day = '12';
