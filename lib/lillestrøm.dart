...
class lillestrom extends StatefulWidget {
  const lillestrom({super.key});

  @override
  State<lillestrom> createState() => _lillestromState();
}

class _lillestromState extends State<lillestrom> {
  String _dropdownValue = "Lillestrøm";
  String Day = '12';
